...
public class Disenio extends javax.swing.JFrame {
    ...
    private void BotonIngresarArchivoActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        //Leer y crear la instancia del archivo
        Archivo archivo= new Archivo(JOptionPane.showInputDialog("Ingrse la direccion de su archivo: "));
        
        //Ejecutar el archivo
        archivo.Ejecutar_archivo();
    }
